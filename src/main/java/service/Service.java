...
public class Service {
    ...
    public Student addStudent(Student student) {
        System.out.println("Service.addStudent is called");
    ...
    public Tema addTema(Tema tema){
        System.out.println("Service.addTema is called");
    ...
    public double addNota(Nota nota, String feedback){
        System.out.println("Service.addNota is called");
        ...
        System.out.println("predare:"+predare+"tema.getDeadline():"+tema.getDeadline());
